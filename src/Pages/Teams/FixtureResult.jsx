   ...
   return(
      <FixtureResultWrapper>
         <div style={{padding:"10px"}}>
            <div class={styles.fixtures_result}>
               <div>
                  Fixtures
               </div>
               <div>
        ...
        {details?.map((item)=>
         <div style={{marginBottom:"0.5rem",paddingBottom:"0.75rem",borderBottom:"1px solid lightgrey"}}>
            <div class={styles.heading_fixture}>
            ...
            <div style={{marginBottom:"0.5rem",marginTop:"0.5rem"}}>
               <div style={{display:"flex",flexDirection:"row",marginBottom:"0.5rem"}}>
                  ...
                  <span class={styles.name_section_cntry}>{item.country1_code}</span>
               </div>
               <div style={{display:"flex",flexDirection:"row",marginBottom:"0.5rem"}}>
                  <img style={{marginRight:"0.5rem"}} width="20px" height="20px" src={item.country2_code_img} alt="ban" />
                  <span class={styles.name_section_cntry}>{item.counry2}</span>
               </div>
            </div>
